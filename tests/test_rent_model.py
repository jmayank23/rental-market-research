...
def trained(tmp_path, monkeypatch, rental_listings_fixture):
    """Train a small model on the rental fixture and return the artifacts."""
    ...
    rent_model.train(rental_path, model_path, metrics_path, TSMC)
    return {
        "model_path": model_path,
        "metrics_path": metrics_path,
        "metrics": json.loads(metrics_path.read_text()),
        "rentals": rental_listings_fixture,
    }
